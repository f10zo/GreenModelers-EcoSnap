...
const appId = 'default-app-id'; // replace if needed
          ...
          <div className="space-y-6 sm:space-y-8 order-2 md:order-1">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                <img src="https://placehold.co/24x24/111827/ffffff?text=M" alt="Mission Icon" width={24} height={24} className="rounded-full p-1 bg-blue-100 dark:bg-blue-900" />
                <div>
                  <h3 className={`font-bold text-lg sm:text-xl md:text-2xl mb-1 sm:mb-2 ${currentTheme.includes("dark") ? "text-white" : "text-black"}`}>Our Mission</h3>
                  <p className={`text-sm sm:text-base md:text-lg ${currentTheme.includes("dark") ? "text-white" : "text-black"}`}>
                    Our <strong>M</strong>ission is to empower communities to protect our lakes and natural habitats by providing a simple way to report pollution and share information.
                  </p>
                </div>
              </div>
              ...
              {/* Get Involved */}
              <div className="flex items-start gap-3 sm:gap-4">
                <img src="https://placehold.co/24x24/111827/ffffff?text=V" alt="Volunteering Icon" width={24} height={24} className="rounded-full p-1 bg-blue-100 dark:bg-blue-900" />
                <div>
                  <h3 className={`font-bold text-lg sm:text-xl md:text-2xl mb-1 sm:mb-2 ${currentTheme.includes("dark") ? "text-white" : "text-black"}`}>How to Get Involved</h3>
                  <p className={`text-sm sm:text-base md:text-lg ${currentTheme.includes("dark") ? "text-white" : "text-black"}`}>
              ...
              {/* Together */}
              <div className="flex items-start gap-3 sm:gap-4">
                <img src="https://placehold.co/24x24/111827/ffffff?text=W" alt="Teamwork Icon" width={24} height={24} className="rounded-full p-1 bg-blue-100 dark:bg-blue-900" />
                <div>
                  <h3 className={`font-bold text-lg sm:text-xl md:text-2xl mb-1 sm:mb-2 ${currentTheme.includes("dark") ? "text-white" : "text-black"}`}>Together, We Can Make a Difference</h3>
                  <p className={`text-sm sm:text-base md:text-lg ${currentTheme.includes("dark") ? "text-white" : "text-black"}`}>
